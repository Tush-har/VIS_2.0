...
# Constants and paths
BASE_DIR = Path(os.getenv("BASE_DIR", r"C:\SPRL/Project"))
TRAINING_DATA_DIR = Path(os.getenv("TRAINING_DATA_DIR", r"C:\SPRL/Training_data"))
MODELS_DIR = Path(os.getenv("MODELS_DIR", r"C:\SPRL/Models"))
MONGODB_URL = os.getenv("MONGODB_URL", "mongodb://localhost:27017")

# Hardcoded base directory for API to read results from CSV (read_results)
CSV_DIR = r"C:\SPRL/Models"
TEMP_DIR = Path(r"C:\SPRL/temp")
...
async def train_model(request: TrainModelRequest):
    try:
        ...
        model.train(data=yaml_path, epochs=30, imgsz=640, project=models_dir, name=project_name)
